...
parser.add_argument('--lr_decay', default=0.5,
                    help="Learning rate decay rate when it does not reduced during specific epoch")
...
parser.add_argument('--optimizer', default="adam",
                    help="Optimizer: can be [gd, momentum, adadelta, adagrad, adam, rmsprop]")
parser.add_argument('--loss_alpha', default=1, type=int,
                    help="Initial loss-alpha value (0-1). Don't use intermediate outputs when 0.")
parser.add_argument('--loss_alpha_zero_epoch', default=25, help="Decrease loss-alpha to zero by this epoch")
...
# Training or Others
parser.add_argument('--is_training', default=True, help="Train model with 91 standard images")
parser.add_argument('--dataset', default="set5",
                    help="Test dataset. [set5, set14, bsd100, urban100, all, test] are available")
parser.add_argument('--training_set', default="ScSR",
                    help="Training dataset. [ScSR, Set5, Set14, Bsd100, Urban100] are available")
...
parser.add_argument('--cache_dir', default="cache",
                    help="Directory for caching image data. If specified, build image cache")
parser.add_argument('--data_dir', default="data", help="Directory for test/train images")
parser.add_argument('--load_model', default=False, help="Load saved model before start")
...
parser.add_argument('--debug', default=False, help="Display each calculated MSE and weight variables")
parser.add_argument('--initialise_log', default=True, help="Clear all tensorboard log before start")
parser.add_argument('--visualize', default=True, help="Save loss and graph data")
parser.add_argument('--summary', default=False, help="Save weight and bias")
